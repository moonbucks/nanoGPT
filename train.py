...
if master_process:
    ...
    os.makedirs(f'./traces/batch_{batch_size}', exist_ok=True)
...
def get_rand_batch(split):
    # we are using fixed vocab size of 50304
...
get_data = get_rand_batch if dataset == 'random' else get_batch
